...
import gimg1 from '../assets/blog/gimg1.jpg'
...
function Gallerypost() {
  return (
    <>
      <div className=" flex justify-between w-full h-8 text-xs pt-1 bg-black container mx-auto">
        <div className=" flex ">
          <English />
          <USD />
        </div>
      ...
      <div className=' container mx-auto mt-10'>
        <a href='#'>
          <img className='w-[100%]' src={gimg1} alt=""></img>
        </a>
      </div>
            ...
            <div className=''>
              ...
              <div className='mt-8 '>
                ...
                <p className='text-[16px] text-[#777777] mt-8'>
                  December 03, 2020 - The Nike Air Zoom SuperRep 2 is designed for high-intensity interval training<br/> (HIIT) in group classes or solo sessions. This second version comes with two updated features for a <br/> bbetter fit: a fully adjustable, burrito-style tongue and a roomier forefoot.
                </p>
                <p className='text-[16px] text-[#777777] mt-8 leading-5'>
                  The SuperRep 2 evolves an important facet of modern fitness — training as sport — and the idea<br/> that it's deserving of footwear designed to support the performance needs specific to these<br/> movements. That’s why the shoe keeps the tech from the original SuperRep, like the forefoot Zoom<br/> Air / for pop on jumps, a reinforced rand to brace against lateral bounds and a flexible “burpee<br/> break” for everyone’s favorite total-body punisher.
                </p>
                <p className='text-[16px] text-[#777777] mt-8'>
                  The Nike Air Zoom SuperRep 2 releases December 10 in China, December 26 throughout EMEA and<br/> January 4 globally.
                </p>
                <p className='text-[16px] text-[#777777] mt-8'>
          ...
          <div className='right-section '>
            ...
            <div className='border w-[350px] h-80  rounded-md mt-10  '>
              <div className='ml-5' >
                ...
                <div className='flex mt-3 group'>
                  <a href="#" className=' w-24 h-16 overflow-hidden rounded-md '>
                    <Link to="/Standrdpost"></Link><img className='w-24  h-16 group-hover:scale-110 duration-500' src={tshirt} alt=""></img>
                  </a>
                  <div className='ml-3'>
