  ...
  return (
    <>
      ...
      <div className=' container mx-auto'>
        <div className='border-l-4 border-[#FAB8C4] w-[100%] h-80 mt-10 bg-[#f9f3f0] rounded-md pl-10 pt-10 mb-10'>
          <h1 className='hover:text-blue-500 duration-500 text-[35px] font-semibold italic'>“An oral history of the AIM away message( by the people who were<br /> there)”</h1>
