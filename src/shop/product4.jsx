        ...
        <div className='grid grid-cols-2 gap-10 pt-[60px] px-24 container mx-auto '>
          <div className='main-div-photos '>
            <div className='flex justify-between items-center'>
              ...
              <div>
                <div>
                  <img className='rounded-lg w-[550px]' src="./src/assets/shop/shoes1.png" alt="" />
                </div>
              </div>
              <div className='hover:scale-110 duration-300'>
            ...
            <div>
              <div className='flex justify-center mt-10'>
                <img className='rounded-full w-14 mx-3 ring-2 ring-[#417EF0]' src="./src/assets/shop/shoes1.png" alt="" />
                <img className='rounded-full w-14 mx-3 hover:ring-2 hover:ring-[#417EF0] duration-300' src="./src/assets/shop/shoes2.png" alt="" />
                <img className='rounded-full w-14 mx-3 hover:ring-2 hover:ring-[#417EF0] duration-300' src="./src/assets/shop/shoes3.png" alt="" />
                <img className='rounded-full w-14 mx-3 hover:ring-2 hover:ring-[#417EF0] duration-300' src="./src/assets/shop/shoes4.png" alt="" />
                <img className='rounded-full w-14 mx-3 hover:ring-2 hover:ring-[#417EF0] duration-300' src="./src/assets/shop/shoes5.png" alt="" />
                <img className='rounded-full w-14 mx-3 hover:ring-2 hover:ring-[#417EF0] duration-300' src="./src/assets/shop/shoes6.png" alt="" />
              </div>
            </div>
